...
class PaddleClient
{
    ...
    {
        return $this->client()->post($this->getApiUrl('/products'), [
            'name' => $name,
    ...
    public function createPriceForPlan(
        ...
        return $this->client()->post($this->getApiUrl('/prices'), $priceObject);
    }
    ...
    public function updateSubscriptionQuantity(
        ...
        return $this->client()->patch($this->getApiUrl('/subscriptions/'.$paddleSubscriptionId), $subscriptionObject);
    }

    public function getSubscription(string $paddleSubscriptionId): Response
    {
        return $this->client()->get($this->getApiUrl('/subscriptions/'.$paddleSubscriptionId));
    }
    ...
    {
        return $this->client()->post($this->getApiUrl('/subscriptions/'.$paddleSubscriptionId.'/cancel'), ['cancel_at_end' => true]);
    }

    public function discardSubscriptionCancellation(string $paddleSubscriptionId)
    {
        return $this->client()->patch($this->getApiUrl('/subscriptions/'.$paddleSubscriptionId), [
    ...
    public function createDiscount(
        ...
        return $this->client()->post($this->getApiUrl('/discounts'), $discountObject);
    }

    public function getPaymentMethodUpdateTransaction(
        string $paddleSubscriptionId,
    ) {
        return $this->client()->get($this->getApiUrl('/subscriptions/'.$paddleSubscriptionId.'/update-payment-method-transaction'));
    }
