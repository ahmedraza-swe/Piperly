...
class LemonSqueezyClient
{
    ...
    public function createCheckout(array $attributes, string $variantId): Response
    {
        ...
        return $this->client()->post($this->getApiUrl('/v1/checkouts'), [
            'data' => [
                'type' => 'checkouts',
    ...
    public function updateSubscription(string $subscriptionId, string $newVariantId, bool $withProration): Response
    {
        ...
        return $this->client()->patch($this->getApiUrl('/v1/subscriptions/'.$subscriptionId), [
            'data' => [
                'type' => 'subscriptions',
                'id' => $subscriptionId,
                'attributes' => $attributes,
    ...
    {
        return $this->client()->get($this->getApiUrl('/v1/variants/'.$variantId));
    }

    public function getVariantPriceModel(string $variantId): Response
    {
        return $this->client()->get($this->getApiUrl('/v1/variants/'.$variantId.'/price-model'));
    }
    ...
    public function createDiscount(
        ...
        return $this->client()->post($this->getApiUrl('/v1/discounts'), [
            'data' => [
                'type' => 'discounts',
                'attributes' => $attributes,
                'relationships' => [
    ...
    {
        return $this->client()->get($this->getApiUrl('/v1/subscriptions/'.$subscriptionId));
    }

    public function cancelSubscription(string $subscriptionId): Response
    {
        return $this->client()->delete($this->getApiUrl('/v1/subscriptions/'.$subscriptionId));
    }
    ...
    public function updateSubscriptionQuantity(string $subscriptionItemId, int $newQuantity, bool $withProration = true): Response
    {
        ...
        return $this->client()->patch($this->getApiUrl('/v1/subscription-items/'.$subscriptionItemId), [
            'data' => [
    ...
    {
        return $this->client()->post($this->getApiUrl('/v1/usage-records'), [
            'data' => [
                'type' => 'usage-records',
                'attributes' => [
                    'quantity' => $unitCount,
