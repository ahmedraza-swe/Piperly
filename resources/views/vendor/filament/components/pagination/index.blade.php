        ...
        <span class="fi-pagination-overview">
            {{
                trans_choice(
                    ...
                    $paginator->total(),
                    [
                        'first' => \App\Support\IntlSafeNumber::format($paginator->firstItem() ?? 0),
                        'last' => \App\Support\IntlSafeNumber::format($paginator->lastItem() ?? 0),
                        'total' => \App\Support\IntlSafeNumber::format($paginator->total()),
                    ],
                )
            }}
        </span>
